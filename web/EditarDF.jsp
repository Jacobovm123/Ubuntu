<%-- 
    Document   : EditarDF
    Created on : 1/10/2020, 09:52:31 PM
    Author     : jacob
--%>
    ...
    <body>
     <div class="container mt-4">
            ...
            <div class="card">
                ...
                <%
                  int id=Integer.parseInt((String )request.getAttribute("id_factura_detalle"));
                ...
                <div class="card-body">
                    ...
                    <form action="ControladorDetalleFactura">
                        ...
                        <input type="text" name="txtid" readonly="" class="form-control" value="<%= u.getId()%>">
                         ...
                         <input type="text" name="txtid_factura" class="form-control" value="<%= u.getIdFactura()%>">
                        <label>ID PRODUCTO</label>
                       
                        <input type="text" name="txtid_producto" class="form-control" value="<%= u.getIdProducto()%>">
                          ...
                          <input type="text" name="txtprecio" class="form-control" value="<%= u.getPrecio()%>">
                              ...
                              <input type="submit" name="accion" value="ActualizarDF1">
